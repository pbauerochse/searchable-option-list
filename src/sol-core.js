...
SearchableOptionList.SOL.prototype = {
    ...
    init: function () {
        ...
        this.config.scrollTarget = this.config.scrollTarget || $(window);
        ...
        var sol = this,
            originalName = this._getNameAttribute();
        ...
        setTimeout(function () {
            ...
            sol.$originalElement
                .data(SearchableOptionList.DATA_KEY, sol)
                .removeAttr('name')
    ...
    _initializeUiElements: function () {
        ...
        this.$container = $('<div class="sol-container"/>')
            .hide()
            .data(SearchableOptionList.DATA_KEY, this)
    ...
    _processSelectOption: function ($option) {
        return new SearchableOptionList.Option($option);
    },

    _processSelectOptgroup: function ($optgroup) {
        var self = this,
            solOptiongroup = new SearchableOptionList.OptionGroup($optgroup),
...
$.fn.searchableOptionList = function (options) {
    ...
    this.each(function () {
        var $this = $(this),
            $alreadyInitializedSol = $this.data(SearchableOptionList.DATA_KEY);
